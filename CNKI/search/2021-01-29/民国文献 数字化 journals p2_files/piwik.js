...
/*</DEBUG>*/
             ...
             * todo:change to RFC4122-compliant UUID   sjs
             */
            ...
            function getRequest(request, customData, pluginMethod, currentEcommerceOrderTs) {
                ...
                //服务端clientId
                var ecpId = getCookie("Ecp_ClientId");
                if(ecpId)
                {
                    request += '&ecpid=' + ecpId;
                }
                ...
                //username
                var Ecp_LoginStuts = getCookie("Ecp_LoginStuts");
                if (Ecp_LoginStuts)
                {
                    var loginstuts = JSON.parse(Ecp_LoginStuts)
                    if(loginstuts.UserName)
                    {
                        var username = loginstuts.UserName;
...
/*</DEBUG>*/
        ...
        //if (_paq.indexOf("setSiteId") == -1) {
        //    _paq.push(['setSiteId', 1]);
        //}
        //if (indexOfArray(_paq, "setSiteId") == -1) {
        //    _paq.push(['setSiteId', 1]);
        //}
